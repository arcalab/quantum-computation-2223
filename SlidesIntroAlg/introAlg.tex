...
\begin{frame}{Examples of Quantum Operations}
        ...
        $\left \sem{ 
                ...
                \end{quantikz}
                \tikzmark{x2} 
        \right } = X : \Complex^2 \to \Complex^2$ (\textbf{not} operation)
        ...
        $\left \sem{ 
                ...
                \end{quantikz}
        \right } 
        = H : \Complex^2 \to \Complex^2$ (\textbf{Hadamard} operation)
...
\begin{frame}{Tackling the Problem via Quantum Parallelism pt. II}
        ...
        \begin{flalign*}
             ...
             & =  U_f \left ( \textstyle{ \frac{1}{\sqrt{2}}(\ket{00} + \ket{10})}
                 \right ) & \text{\{Defn. of $\otimes$\}} \\
             & = \textstyle{\frac{1}{\sqrt{2}}(\ket{0} \otimes \ket{0 \oplus \alert{f(0)}} 
               + \ket{1} \otimes \ket{0 \oplus \alert{f(1)}})} & \text{\{Defn. of $U_f$\}} \\
             & = \underbrace{\textstyle{\frac{1}{\sqrt{2}}\ket{0} \otimes \ket{\alert{f(0)}} 
               + \frac{1}{\sqrt{2}}\ket{1} \otimes \ket{\alert{f(1)}}}}_{\text{Info.
               of $f(0)$ and $f(1)$ in a single run of $U_f$!}} & \{0 \oplus x = x\}
        \end{flalign*}
...
\begin{frame}{Tackling the Problem via Parallelism and Interference pt. I}
        ...
        \begin{center}
                        \begin{quantikz}[transparent]
                                ...
                                rounded corners,fill=blue!10},background]{\tiny{parallelism}}
                                & \gate[wires=2]{U_f} \gategroup[wires=2,steps=1,style={dashed,
                                rounded corners,fill=blue!10}, label style={label position = 
                                below, yshift=-0.4cm},background]
                                {\tiny{interference pattern}}
                                & \gate{H} 
                                \gategroup[wires=1,steps=1,style={dashed,
                                rounded corners,fill=blue!10},background]{
                                \tiny{wave collapse}}
                                & \qw \\
                        ...
                        \end{quantikz}
        \end{center} 
        The wave collapse informs us of the global property
\end{frame}
...
\begin{frame}{Preliminary Calculation}
        ...
        \begin{flalign*}
                ...
                (\ket{0} - \ket{1}) \right ) &  \\
                & =  
                U_f \left (\ket{x}\ket{0} - \ket{x}\ket{1} \right ) & \{\text{Distributivity
                of $\otimes$ over $+$ }\} \\
                & =  
                ...
                \ket{x}\alert{\ket{f(x)}} - 
                \ket{x}\alert{\ket{\neg f(x)}}  &  
                \{0 \oplus x = x \text{ and } 1 \oplus x = \neg x \} \\
                & =  
                \ket{x} \otimes (\alert{\ket{f(x)}} - 
                \alert{\ket{\neg f(x)}}) &
                \{ \text{Distributivity of $\otimes$ over $+$} \}
        \end{flalign*}
...
\begin{frame}{Tackling the Problem via Parallelism and Interference pt. II}
        ...
        \begin{flalign*}
              ...
              & = (H \otimes I) \comp U_f
              \left ( \ket{+} \otimes \ket{-} 
              \right ) & \text{\{Defn. of $H \otimes I$\}} \\
              & = \textstyle{\frac{1}{\sqrt{2}}} (H \otimes I) \comp U_f
              \left ( (\ket{0} + \ket{1})
                      \otimes \ket{-} 
              \right ) & \text{\{\ \dots\}} \\
              ...
              \end{cases}& \text{\{Defn. of $H \otimes I$\}} 
      \end{flalign*}
      }
\end{frame}
